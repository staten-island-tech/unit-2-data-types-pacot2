...
if verb1 == verb2:
    ...
    print(f"It's a {adj} day outside. As you {verb1} in preparation to {verb2} later in the day, {number} of {noun} stops you! As you start to panic, you look around to see {celeb} watching you from across the street, getting ready to save you. You breathe a sigh of relief, but you come to realize {celeb} is not rooting for you. ")